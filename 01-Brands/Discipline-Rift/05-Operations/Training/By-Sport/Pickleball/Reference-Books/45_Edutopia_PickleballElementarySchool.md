...
source_url: "https://www.edutopia.org/article/pickleball-elementary-school-phys-ed/"
source_title: "Pickleball in Elementary School (Edutopia)"
author: "Edutopia"
publisher: "Edutopia (George Lucas Educational Foundation)"
language: en
tier: "Tier 4 — Skip como currículo, citar por dos datos"
status: active
canonical: false
used_for_ai: true
...
## Qué es esta fuente
**Tier 4 — Skip como currículo, citar por dos datos** · Edutopia (George Lucas Educational Foundation) · idioma: en

Pieza de advocacy: sin drills nombrados, sin progresiones, enseña la regla de dos botes en lenguaje adulto y omite explícitamente las violaciones de cocina. Dos cosas citables: la aritmética de cancha (4 canchas de pickleball caben en una de tenis, hasta 8 en un gimnasio estándar con cinta de suelo) y los precios (sets de paleta desde ~$10, redes desde ~$40). Menciona también las becas de arranque escolar de USA Pickleball.

## Cómo llegó al vault
Texto legible extraído de la página web original el 2026-09-22. Fuente: <https://www.edutopia.org/article/pickleball-elementary-school-phys-ed/>
...
---
Pickleball in Elementary School for Physical and Social Well-Being | Edutopia
...
When I first thought about bringing pickleball to our school district, I thought a pickleball league for teachers might go a long way toward improving teaching morale and giving our community something to look forward to. We sent out a survey, and more than 250 staff members expressed interest; that was the start of our first pickleball tournament for the school district. I also contacted the PTO about creating a schoolwide pickleball tournament for students and teachers.

Basics of Pickleball

All our students have the opportunity to play pickleball in PE. Getting pickleball set up isn’t much different from any other sport, and most schools could easily integrate this into their PE curriculum. Paddle sets start at around $10, and pickleball nets start at around $40, both lower start-up points than other racquet sports. There are also grants that will help schools start pickleball programs in their buildings, such as the ones offered through USA Pickleball .

close modal

Courtesy of Sarah Wysocki

Courtesy of Sarah Wysocki

Pickleball is great for children because it is played on a small court with a lightweight, easy-to-maneuver paddle. Kids can cover the court easily, and the equipment isn’t overly burdensome for little hands. Elementary-aged children have all the skills needed to start learning.
