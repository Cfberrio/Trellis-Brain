...
## Children
- [[01-Brands/Discipline-Rift/03-Evidence/DRF-Knight-Shadow-Phase-1-Feedback|DRF Knight Shadow Phase 1 Feedback]]
...
- [[01-Brands/Discipline-Rift/03-Evidence/Meetings/2026-05-16-Call-Yassine-Franchise-Commitment|Meeting — 2026-05-16 Call Yassine (Franchise Commitment)]]
- [[01-Brands/Discipline-Rift/03-Evidence/Meetings/2026-05-18-SyncUp-Yassine-Luis-DR-Outreach|Meeting — 2026-05-18 SyncUp Yassine + Luis (DR Outreach)]]
...
Hub for DR evidence + research + feedback artifacts. Each note here is **proof** — either:

- a **performance signal** (practice reports, feedback logs, workflow logs)
- a **founder voice source** (Q&A themes, interview transcripts)
- a **meeting record** (decisions captured from live conversations)
- an **AI feedback synthesis** (decision-grade analysis of real conversion threads)

Use this hub to find ground-truth before changing positioning, scripts, or playbooks.

## Sub-folder roles

| Folder | Role |
|---|---|
| `Founder-Voice/` | Direct-quote founder transcripts + Q&A themes (Luis on DR) |
| `Practice-Reports/` | Season-by-season practice reports, attendance, coach notes |
| `Meetings/` | Date-stamped meeting records with decisions + follow-ups |
