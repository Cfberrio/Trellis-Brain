...
notion_page_id: c1e04528-85a8-8213-881c-811b1520f2c5
notion_url: https://app.notion.com/p/WEEK-6-c1e0452885a88213881c811b1520f2c5
notion_db: COACH HUB
section: My Season
page_type: Week
sport: Volleyball
...
<callout icon="🎲" color="gray_bg">
	**WARM-UP GAME — you pick**
	[[VOLLEYBALL TAG]] — energy is flat. Best fit for a final-week session.
...
<callout icon="🎲" color="gray_bg">
	**CFU GAME — you pick**
	[[MINI VOLLEYBALL]] — full game shape for the last session. Best fit for Week 6.
	[[SPACE & SUPPORT]] — checking decisions and covering space.
	[[TEAM RALLY]] — connection matters more than winning.
	[[CATCH → CONNECT → SEND]] — a group still working on the first contact.
	*Whole bank: [[VOLLEYBALL CFU GAMES]].*
</callout>
**Round 1:** familiar setup. Record useful early calls, playable first contacts and connected sequences.
**Round 2:** change one of partner, entry or starting spot. Use the same observations.
**Round 3:** remove coach-directed destinations and let players solve.
Keep catch bridges declared and scored separately. Use a short replay for a breakdown, then return to the game.
