...
notion_page_id: 3d804528-85a8-8194-946f-d2542b9c4a9d
notion_url: https://app.notion.com/p/START-HERE-3d80452885a88194946fd2542b9c4a9d
notion_db: COACH HUB
section: Start Here
page_type: Hub
sport: All Sports
...
<callout icon="💬" color="gray_bg">
	**HOW DR COMMUNICATES**
	**Main DR coach group**: season-wide announcements, important current updates, anything that applies to every coach.
	**Day chats**: one chat per coaching day. Reminders and coordination for coaches working that day.
	**Your job**: be in the main group AND in the day chat for every day you coach. Tuesday and Thursday coach = Main + Tuesdays + Thursdays.
	**Notion** holds the evergreen rule. **WhatsApp** holds what changed today. If a WhatsApp reminder keeps repeating, the rule lives here.
</callout>
...
<callout icon="📏" color="gray_bg">
	**COACH NON-NEGOTIABLES**
	...
	- Coach the DR way: Practice Design, Progression Ladder, Coach Rules.
	- Keep players safe. Boundaries set, head counts done, nobody unaccounted for.
