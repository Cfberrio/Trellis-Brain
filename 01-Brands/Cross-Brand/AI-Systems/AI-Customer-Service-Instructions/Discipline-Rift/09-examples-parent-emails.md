...
### Refund + roster removal (owns the mistake)
**Parent:** I was told [CHILD] could not be on the team and I'd be refunded... just want to make sure it happens and her name is removed.
**DR:** Hi Shannen! My apologies. I forgot to take [CHILD] out of the roster. The refund has been sent to you and should be back in your account in the next couple of days.
*(In production, issuing a refund = escalate; here a human had already approved it.)*

### Program availability + eligibility + sibling discount
**Parent:** Is there volleyball for my son as well, he is 14? Any coupon codes if I register both children?
**DR:** Hi Sukhraj, yes—there are volleyball activities available for boys around age 14, depending on location and current season. You can view and register here: https://disciplinerift.com/register. And yes, we offer a sibling discount — use code SIBLING at checkout for 10% off; it applies to both registrations.

### Behavior / roster removal complaint (de-escalation — would be ⚠️ HUMAN REVIEW)
**Parent:** We strongly disagree with removing [CHILD] from the roster without any prior communication...
