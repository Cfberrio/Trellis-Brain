...
## The 8 intake inputs (gather before quoting)
Any real proposal needs these. If missing, ask for them first:
1. **Event type** (private / corporate / birthday / brand)
2. **Date + time window**
3. **Guest count** (catering boards **minimum 30 guests**)
4. **Setup tier** (drop-off / standard $400 / premium themed $600)
5. **Add-ons** (experience stations, staff, fondue, etc.)
6. **Reference photos** (desired aesthetic/style)
7. **Venue / location**
8. **Special requirements** (dietary, theme, branded elements)

> Step-2 reply pattern: "Thank you for reaching out — we'd love to help make your event special! To put together the best proposal, a few quick questions: occasion/event type · approximate date & time · roughly how many guests · a style in mind (grazing board, spread, individual servings) · any dietary restrictions."
...
| Item | Price |
|---|---|
| Cheese board — Classic (4–6) | $139 |
| Cheese board — Medium (10–12) | $169 |
| Cheese board — Large (16–20) | $249 |
| Grazing table / Island package | **$25 / guest** (30 guest min) |
| Floral Rustic package | +$10 / guest |
| Experience station (Tiramisu, Strawberry Dubai, Candy, Chocolate/Cheese Fondue) | +$12 / guest / station |
| Setup — Standard | $400 |
| Setup — Premium themed | $600 |
| Staff | $25 / hour |
| Custom Styled package | **Custom only** — consultation/lead path, Luis prices it |

**Quote line items:** guests × per-guest base → setup tier → staff hours → stations → total → **50% deposit** → 50% balance → hold/expiry.
...
## Definition of done
✓ 50% deposit collected ✓ date locked ✓ client has written quote ✓ setup tier + add-ons confirmed ✓ GHL/ClickUp record updated ✓ referral source tagged.

## Booking conditions to state plainly (never bury)
- 50% deposit to hold; balance 24h before.
- Boards min 30 guests for grazing/table catering.
- No outside food added to the grazing table without prior approval.
- CTS equipment (boards, trays, stands, florals, lighting) is CTS property — damage/loss charged at replacement cost.
