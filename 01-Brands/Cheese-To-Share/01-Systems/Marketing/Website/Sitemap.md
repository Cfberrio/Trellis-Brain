...
- Main navigation: Menu, Catering, Location, Story, Contact
- Main CTA: Order Now
- Secondary CTA: Book Now (for catering)
- Scroll flow: Hero > Menu > Catering > Location > Story > Contact/Footer

## Routing rules
- **Order Now** on Menu routes to [[01-Brands/Cheese-To-Share/01-Systems/Marketing/Website/Pages/Location|CTS Location Page]]
- [[01-Brands/Cheese-To-Share/01-Systems/Marketing/Website/Pages/Location|CTS Location Page]] presents Uber Eats first, then DoorDash, then Pickup
- **Book Now** routes to catering inquiry / ordering flow
- Contact page uses GoHighLevel form and admin notification logic

## Strategic note
The site needs to feel cinematic in presentation but very explicit in conversion routing.
